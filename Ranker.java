...
public class Ranker {
    ...
    double[] ballsScoredWeightAuto = { 12, 12, 12, 12, 12, 12 };// [Red1,Red2,Red3,Blue1,Blue2,Blue3]
    double[] gearsOnHookWeightAuto = { 3, 3, 3, 3, 3, 3};
    double crossedBaseLineWeight = 10;
